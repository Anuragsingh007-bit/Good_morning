...
import random
from application_functions import smart_plan, temperature_of_city, get_news, news_summarizer, smart_plan
# --- Page Configuration ---
st.set_page_config(
...
def schedule_page():
    ...
    if st.button("Let's Plan"):
        if city:
            smart_plan_result = smart_plan(city)
            st.subheader(smart_plan_result)
